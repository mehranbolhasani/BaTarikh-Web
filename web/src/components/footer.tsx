...
export function Footer() {
  return (
    <footer className="relative md:sticky md:bottom-0 mx-auto max-w-full pb-12 pt-24 md:pt-0 col-span-1">
      <div className="flex flex-col items-start justify-between text-sm text-neutral-600">
